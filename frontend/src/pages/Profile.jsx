    ...
    <div className="min-h-screen bg-gray-900 text-white py-10 px-4">
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="bg-gray-800 p-6 rounded-2xl grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
          <div>
            <p className="text-4xl font-bold">{user.rating || 0}</p>
            <p className="text-gray-400">Rating</p>
          </div>
          <div>
            <p className="text-4xl font-bold">{user.wins || 0}</p>
            <p className="text-gray-400">Wins</p>
          </div>
          <div>
            <p className="text-4xl font-bold">{user.losses || 0}</p>
        ...
        <div className="bg-gray-800 p-6 rounded-2xl">
          ...
          <ul className="space-y-2">
            ...
            { (user.recentGames || []).length === 0 && <p className="text-gray-400 text-center">No recent games</p> }
          </ul>
        </div>
